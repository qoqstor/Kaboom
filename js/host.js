...
(() => {
  ...
  function renderQuestion(q) {
    ...
    q.options.forEach((opt, i) => {
      ...
      div.dataset.i = i;
      div.innerHTML = `<span class="shape">${SHAPES[i]}</span><span></span>`;
      div.lastElementChild.textContent = opt;
  ...
  function renderReveal(data) {
    ...
    data.counts.forEach((n, i) => {
      ...
      item.firstElementChild.textContent = `${SHAPES[i]} ${currentQ ? currentQ.options[i] : ''}`;
